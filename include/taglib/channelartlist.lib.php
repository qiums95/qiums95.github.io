...
function lib_channelartlist(&$ctag,&$refObj)
{
    ...
    $dsql->SetQuery("SELECT id,typename,typenameen,typedir,typeimg,seotitle,content,description,isdefault,ispart,defaultname,namerule2,moresite,siteurl,sitepath 
