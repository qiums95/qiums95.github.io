    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "<a href='$mlink'><i class=\"iconfont icon-jiantou\"></i>上一篇</a>";
                $this->PreNext['prewap'] = "<a href=\"view.php?aid={$preRow['id']}\">上一篇：{$preRow['title']}</a>  ";
                $this->PreNext['preimg'] = "<a href='$mlink'><img src=\"{$preRow['litpic']}\" alt=\"{$preRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['pre'] = "<a><i class=\"iconfont icon-jiantou\"></i>没有了</a>";
                $this->PreNext['prewap'] = "<a href=\"javascript:;\">上一篇：没有了</a>  ";
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['next'] = "<a href='$mlink'><i class=\"iconfont icon-jiantou1\"></i>下一篇</a>";
                $this->PreNext['nextwap'] = "<a href=\"view.php?aid={$nextRow['id']}\">下一篇：{$nextRow['title']}</a> ";
                $this->PreNext['nextimg'] = "<a href='$mlink'><img src=\"{$nextRow['litpic']}\" alt=\"{$nextRow['title']}\"/></a> ";
            }
            else
            {
                $this->PreNext['next'] = "<a><i class=\"iconfont icon-jiantou1\"></i>没有了</a>";
                $this->PreNext['nextwap'] = "<a href=\"javascript:;\">下一篇：没有了</a> ";
